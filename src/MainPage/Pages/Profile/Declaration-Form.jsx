                                ...
                                <div  style={{ display: 'inline-flex' }}>
                                    {/* {candidate_uan_no.map(document => (
                                        ...
                                        <input key={document.key} type="text" style={{ width: '40px' }}></input>
                                            ...
                                            <input disabled="disabled" onChange={this.setuan} defaultValue={otherdetails.uan} readOnly={this.state.Is1952||this.state.Is1955} key={document.key} type="text" style={{ width: '100%'  }} className="form-control"></input>
