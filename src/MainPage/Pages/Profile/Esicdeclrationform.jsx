    ...
    render() {
        ...
        return (
            ...
            <div className="container" style={{
                ...
                <div id='#uu' className="border bg-white" >
                                ...
                                <div className="col-md-12">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td >
                                                                ...
                                                                <input defaultValue={this.state.name} type="text" name="" className="form-control" /><br />
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td >
                                                                शाखा कार्यालय
                                                                <br />Branch Office
                                                       <input defaultValue={this.state.branch_name} type="text" name="" className="form-control" /><br />
                                                            </td>
                                                            <td >
                                                                औषधालय
                                                                <br />Dispensary
                                                                    <input defaultValue={this.state.esic_name} type="text" name="" className="form-control" /><br />
                                                            </td>
                                            ...
                                            <div className="row">
                                                <div className="table-responsive" style={{ overflow: 'hidden' }}>
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <div style={{ width: '200px', height: '200px', border: '1px solid black', marginLeft: '33%' }}>
                                    ...
                                    <div className="title d-flex">
                                        ...
                                        <p style={{ marginLeft: '30%' }}>
                                            ...
                                            <br />बीमाकृत व्यक्ति के हस्ताक्षर/अंगूठे का निशान
