   ...
   render() {
    ...
    const columns = [
      ...
      },      
      {
        ...
        render: (text, record) => (
          <a href="/blue/app/accounts/invoices-view">#{text}</a>
          ),
            ...
            <div className="dropdown dropdown-action text-right">
                <a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_vert</i></a>
                        <div className="dropdown-menu dropdown-menu-right">
                          <a className="dropdown-item" href="/blue/app/accounts/invoices-edit"><i className="fa fa-pencil m-r-5" /> Edit</a>
                          <a className="dropdown-item" href="/blue/app/accounts/invoices-view"><i className="fa fa-eye m-r-5" /> View</a>
        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              <a href="/blue/app/accounts/invoices-create" className="btn add-btn"><i className="fa fa-plus" /> Create Invoice</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
